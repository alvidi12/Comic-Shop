...
import { loginHandler } from "../JSFunctions/LoginFunction.js";
...
export default function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Aquí llamamos a la función lógica
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                        ...
                        setMensaje(""); // limpiamos el mensaje cuando el usuario corrige
                      }}
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                        ...
                        setMensaje(""); // limpiamos el mensaje al cambiar contraseña
                      }}                  />
                </div>
